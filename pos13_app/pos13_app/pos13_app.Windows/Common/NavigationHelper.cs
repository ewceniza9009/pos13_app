...
namespace pos13_app.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
            ...
            AcceleratorKeyEventArgs e)
        {
            ...
            // Only investigate further when Left, GetRightString, or the dedicated Previous or Next keys
            // are pressed
                ...
                (int)virtualKey == 166 || (int)virtualKey == 167))
            {
                ...
                {
                    // When the next key or Alt+GetRightString are pressed navigate forward
                    e.Handled = true;
